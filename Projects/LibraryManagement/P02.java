...
public class LibrarySystemDemo {
    public static void main(String[] args) {
        ...
        library.processCheckout("U001", "B001");
        library.processCheckout("U002", "D001");
        library.processCheckout("U001", "M001");
        
        // 8. Display item details (Polymorphism - different implementations)
        ...
        // 10. Demonstrate renewal functionality (Interface implementation)
        System.out.println("\n--- Renewal Operations ---");
        if (book1 instanceof Renewable) {
            Renewable renewableBook = (Renewable) book1;
            renewableBook.renewItem();
        }
        
        if (dvd1 instanceof Renewable) {
            Renewable renewableDvd = (Renewable) dvd1;
            renewableDvd.renewItem();
        }
        
        // 11. Return items
        System.out.println("\n--- Return Operations ---");
        library.processReturn("U001", "B001");
        library.processReturn("U002", "D001");
        
        // 12. Generate reports (Method overloading)
        library.generateReport();
        library.generateReport("detailed");
        
        // 13. Final catalog display
        library.displayCatalog();
        
        System.out.println("\n" + "=".repeat(60));
        System.out.println("PROJECT DEMONSTRATION COMPLETE!");
        System.out.println("All Java concepts from basics to OOP have been covered.");
        System.out.println("=".repeat(60));
    }
}